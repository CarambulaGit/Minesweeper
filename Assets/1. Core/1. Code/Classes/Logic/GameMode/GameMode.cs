...
namespace CodeBase.Logic {
    ...
    public class GameMode {
        ...
        private static GameMode EasyMode() => new GameMode(8, 8, 10, Difficulty.Easy);

        private static GameMode MediumMode() => new GameMode(14, 14, 40, Difficulty.Medium);

        private static GameMode HardMode() => new GameMode(30, 16, 100, Difficulty.Hard);
